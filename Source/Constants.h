...
static const juce::Colour darkBlue = juce::Colour::fromFloatRGBA(0.1f, 0.f, 0.7f, 1.0f);
static const juce::Colour blueAlpha = juce::Colour::fromFloatRGBA(0.43f, 0.83f, 1.0f, 0.2f);
static const juce::Colour darkBlueAlpha = juce::Colour::fromFloatRGBA(0.1f, 0.f, 0.7f, 0.2f);
static const juce::Colour yellow = juce::Colour::fromFloatRGBA(0.1f, 0.f, 0.7f, 0.2f);
